    ...
    <div class="navbar-header">
     ...
     <span class="btn-sidbar navbar-collapse" onclick="toogle()"><span class="glyphicon glyphicon-th-list"></span></span><!--SITE NO NENU ABERTO-->
       ...
       ?>
        ...
        <?php 
        $sql_not_inf = mysql_query("SELECT idtroca , idUsuarioOF as id_interesse , usuario.nome as interesse ,idProdutoOF,idProdutoINT FROM `trocaoferta` , usuario WHERE `idUsuarioOF` = usuario.idUsuario and `idUsuarioINT` = $UserId and status = 0");
        ...
        while ($Not_inf = mysql_fetch_object($sql_not_inf)){
                  ...
                  $Prod_dono = $Not_inf->idProdutoINT; 
